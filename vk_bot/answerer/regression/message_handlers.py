...
from vk_bot.answerer.regression.keyboards import Keyboards
from vk_bot.answerer.regression.regression import Regression
from vk_bot.answerer.regression.scripted_phrases import Phrases
...
class Handlers:
    ...
    def __init__(self, vk_api_method: VkApiMethod, db: BotDatabase, user: User, regression: Regression):
    ...
    def opt_alg_selection(self) -> Response:
        ...
        """
        self.regression.update_step('opt_alg_selection')
    ...
    def input_func(self) -> Response:
        ...
        Response
            Сообщение для пользователя.
        """
        self.regression.update_step('input_func')
    ...
    def func(self, text: str) -> Response:
        ...
        try:
            ...
            self.regression.update_func(func)
