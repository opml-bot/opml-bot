...
from solver_core.inner_point.handlers.input_validation import check_expression
from vk_bot.answerer.innerpoint.keyboards import Keyboards
from vk_bot.answerer.innerpoint.innerpoint import InnerPoint
from vk_bot.answerer.innerpoint.scripted_phrases import Phrases
...
class Handlers:
    ...
    def __init__(self, vk_api_method: VkApiMethod, db: BotDatabase, user: User, innerpoint: InnerPoint):
    ...
    def opt_alg_selection(self) -> Response:
        ...
        """
        self.innerpoint.update_step('opt_alg_selection')
    ...
    def input_func(self) -> Response:
        ...
        Response
            Сообщение для пользователя.
        """
        self.innerpoint.update_step('input_func')
    ...
    def func(self, text: str) -> Response:
        ...
        try:
            ...
            self.innerpoint.update_func(func)
