...
class Update(NamedTuple):
    ...
    ONEDIMOPT_X0 = "UPDATE onedimopt SET x0 = ? WHERE user_id = ?"
    ONEDIMOPT_C1 = "UPDATE onedimopt SET c1 = ? WHERE user_id = ?"
    ONEDIMOPT_C2 = "UPDATE onedimopt SET c2 = ? WHERE user_id = ?"
    ONEDIMOPT_MAX_ARG = "UPDATE onedimopt SET max_arg = ? WHERE user_id = ?"
